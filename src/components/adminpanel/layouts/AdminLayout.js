      ...
      <div className={`sidebar pe-1  pb-3 ${buttonToggler ? "open" : ""}`}>
        <nav className="navbar navbar-light">
          <Link to={"/vendor"} className="navbar-brand mx-4 mb-3">
            <h3 className="text-light">Admin</h3>
          </Link>
          <div className="navbar-nav w-100">
            ...
            <Link to={"/admins/all-category"} className="nav-item nav-link">
              <i className="fa fa-list me-2"></i>All Category
            </Link>
            <Link to={"/admins/all-keywords"} className="nav-item nav-link">
              <i className="fa fa-list me-2"></i>All Keywords
            </Link>
